...
class DbRealm {
    ...
    def isPermitted(principal, requiredPermission) {
        ...
        def results = ShiroUser.executeQuery("select distinct p from ShiroUser as user join user.job as pr join pr.permissions as p where user.username = '$principal'")
